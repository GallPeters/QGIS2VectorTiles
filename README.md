...
**QGIS2VectorTiles** packs a QGIS project into a fully styled vector tile package ready for MapLibre. It lets users design maps in the familiar and flexible QGIS Desktop and export stunning MapLibre client-side web maps using GDAL’s powerful MVT driver.

The output bundle includes:
- Vector tiles (`XYZ` directory)
- A MapLibre style (`JSON` and sprites)
