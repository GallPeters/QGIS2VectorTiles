...
- **Install** the plugin from the **[QGIS Plugin Repository](https://plugins.qgis.org/plugins/QGIS2VectorTiles/)** or via the built-in Plugin Manager.
- **Run** the processing tool and wait a few seconds after it finishes.
- **View** a web version of your QGIS project that opens automatically in your browser.
